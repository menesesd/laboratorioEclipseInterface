...
public class VentanaPrincipal extends JFrame {
	...
	public VentanaPrincipal() {
		...
		cmb_tipo.setModel(new DefaultComboBoxModel(new String[] {"Analg\u00E9sico", "Anal\u00E9ptico", "Anest\u00E9sico", "Anti\u00E1cido", "Antidepresivo ", "Antibi\u00F3ticos"}));
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if(rdCofarma.isSelected()) {
				 ...
				 String resultado;
		            resultado = ordenPedido.validar(txt_nombreMedicamento.getText(), String.valueOf(cmb_tipo.getSelectedItem()),
		                    txt_cantidad.getText(),distribuidor ,
